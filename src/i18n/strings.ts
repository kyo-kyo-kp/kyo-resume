...
export interface UiStrings {
  ...
  platform: { eyebrow: string; title: string; problem: string; approach: string; change: string; differently: string; criteria: string; scope: string; stages: string; stage: string; didWhat: string; stack: string; diagram: string; evidence: string; myPart: string };
  stories: { eyebrow: string; title: string; subtitle: string; problem: string; approach: string; change: string; evidence: string; myPart: string; teamPart: string; groups: Record<'data' | 'platform' | 'backend', string> };
  how: { eyebrow: string; title: string; seeCase: string };
  ai: { eyebrow: string; title: string; changed: string; how: string; guardrails: string; limitations: string; diagram: string };
...
const ko: UiStrings = {
  ...
  platform: { eyebrow: '플랫폼', title: '수집부터 시각화까지, 끝에서 끝까지', problem: '문제', approach: '접근', change: '바뀐 것', differently: '지금이라면 다르게', criteria: '재설계 판단 기준', scope: '범위 판단', stages: '단계별로 내가 한 것', stage: '단계', didWhat: '내가 한 것', stack: '기술', diagram: '운영 중인 구조와 설계한 구조', evidence: '근거', myPart: '직접 구현과 팀의 몫' },
  stories: { eyebrow: '이야기', title: '문제에서 시작한 아홉 이야기', subtitle: '문제가 먼저 옵니다. 숫자는 각주에만 둡니다. 직접 구현한 것과 팀과 함께한 것을 나눠 적었습니다.', problem: '문제', approach: '접근', change: '바뀐 것', evidence: '근거', myPart: '직접 구현', teamPart: '팀과 함께', groups: { data: '데이터 플랫폼과 리더십 · 2024 –', platform: '글로벌 플랫폼 · 2022 – 2024', backend: '백엔드 토대 · 2011 – 2022' } },
  how: { eyebrow: '일하는 방식', title: '원칙은 케이스로 증명합니다', seeCase: '케이스' },
  ai: { eyebrow: 'AI 워크플로우', title: 'AI로 달라진 일', changed: '달라진 일', how: '어떻게', guardrails: '지킨 것 · 가드레일', limitations: '정직하게 쓴 한계', diagram: '에이전트가 데이터에 닿는 경로' },
...
const en: UiStrings = {
  ...
  stories: { eyebrow: 'Stories', title: 'Nine stories that start with a problem', subtitle: 'The problem comes first. Numbers stay in the footnotes. What I built myself and what the team did are marked separately.', problem: 'Problem', approach: 'Approach', change: 'What changed', evidence: 'Evidence', myPart: 'Built myself', teamPart: 'With the team', groups: { data: 'Data platform & leadership · 2024 –', platform: 'Global platform · 2022 – 2024', backend: 'Backend foundations · 2011 – 2022' } },
  how: { eyebrow: 'How I work', title: 'Principles, each backed by a case', seeCase: 'Case' },
  ai: { eyebrow: 'AI workflow', title: 'What AI changed', changed: 'What changed', how: 'How', guardrails: 'What I protected · guardrails', limitations: 'Honest limitations', diagram: 'How agents reach the data' },
