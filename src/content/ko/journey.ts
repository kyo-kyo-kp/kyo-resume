...
export const chapters: Chapter[] = [
  ...
  },
  {
    ...
    period: '2024.07 – 현재',
    summary:
      '일본 픽코마의 데이터 파이프라인과 사내 시각화 플랫폼, 세그먼트·추천·AI 분석을 맡고 있습니다. 2025년 10월부터 실질적으로 팀을 리딩하고 2026년 1월 데이터인텔리전스 팀장이 됐습니다.',
    lesson:
      '데이터 팀의 완성은 화면이 아니라 "현업이 반복해서 쓰는가"였습니다. 그리고 팀장의 일은 개발이 아니라, 팀원이 각자 역할을 찾고 안정적으로 일할 수 있게 범위와 우선순위를 정리하는 것이었습니다.',
